...
import { LEATHER, BRASS, UTILITY } from '../colors';
 ...
 */
export function LeatherMaterial({ color = LEATHER[900], roughness = 0.6, metalness = 0.05, ...props }: React.JSX.IntrinsicElements['meshStandardMaterial']) {
