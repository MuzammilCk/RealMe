...
import { WALNUT, LEATHER, SCENE } from './colors';
  ...
  return (
    <group>
      <mesh receiveShadow position={[0, 0, 0]}>
        ...
        <meshStandardMaterial map={wood} roughness={0.55} metalness={0.04} color={WALNUT[900]} />
      </mesh>
      ...
      {(
        ...
        <mesh key={i} castShadow receiveShadow position={p}>
          ...
          <meshStandardMaterial color={LEATHER[900]} roughness={0.75} />
        </mesh>
      ))}
      ...
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.86, 0]} receiveShadow>
        ...
        <meshStandardMaterial color={SCENE.shadow} roughness={1} />
      </mesh>
    </group>
  );
}
